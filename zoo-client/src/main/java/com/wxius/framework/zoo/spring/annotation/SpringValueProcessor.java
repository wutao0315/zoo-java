...
import com.wxius.framework.zoo.spring.property.SpringValueDefinition;
 ...
 * @since 2017/12/20.
 */
public class SpringValueProcessor extends ZooProcessor implements BeanFactoryPostProcessor, BeanFactoryAware {
  ...
  private void doRegister(Object bean, String beanName, Member member, Value value) {
    ...
    for (String key : keys) {
      ...
      if (member instanceof Field) {
        ...
        logger.error("Zoo @Value annotation currently only support to be used on methods and fields, "

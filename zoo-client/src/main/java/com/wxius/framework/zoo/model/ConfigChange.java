 ...
 *
 */
package com.wxius.framework.zoo.model;
...
public class ConfigChange {
  ...
  /**
   * Constructor.
   * @param name the namespace of the key
   * @param propertyName the key whose value is changed
   * @param oldValue the value before change
   * @param newValue the value after change
   * @param changeType the change type
   */
  public ConfigChange(String name, String propertyName, String oldValue, String newValue,

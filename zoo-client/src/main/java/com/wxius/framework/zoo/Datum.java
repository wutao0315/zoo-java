...
public interface Datum {
   ...
   */
  void addChangeListener(DatumChangeListener listener);
   ...
   * @since 1.0.0
   */
  void addChangeListener(DatumChangeListener listener, Set<String> interestedKeys);
   ...
   *                              For more details, see {@link com.wxius.framework.zoo.spring.annotation.ZooConfigChangeListener#interestedKeyPrefixes()}
   ...
   * @since 1.1.0
   */
  boolean removeChangeListener(DatumChangeListener listener);

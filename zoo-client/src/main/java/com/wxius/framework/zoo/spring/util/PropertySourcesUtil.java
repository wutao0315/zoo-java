 ...
 *
 */
package com.wxius.framework.zoo.spring.util;
...
public class PropertySourcesUtil {
   ...
   * @param environment : Ensure ZooBootstrapPropertySources is still the first in the environment
   */
  public static void ensureBootstrapPropertyPrecedence(ConfigurableEnvironment environment) {
    ...
    PropertySource<?> bootstrapPropertySource = propertySources
        .get(PropertySourcesConstants.ZOO_BOOTSTRAP_PROPERTY_SOURCE_NAME);

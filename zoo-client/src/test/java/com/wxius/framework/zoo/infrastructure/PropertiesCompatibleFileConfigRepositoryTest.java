...
import com.wxius.framework.zoo.model.ConfigFileChangeEvent;
...
//    assertSame(someProperties, configFileRepository.getDatum());
...
//
//    assertSame(anotherProperties, configFileRepository.getDatum());

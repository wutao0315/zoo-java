...
public class AbstractDatumTest {
  ...
  /**
   * @see AbstractDatum#fireConfigChange(ConfigChangeEvent)
   */
  @Test
  public void testFireConfigChange_cannot_notify() throws InterruptedException {
    AbstractDatum abstractConfig = spy(new ErrorConfig());
    final String namespace = "app-namespace-0";

    DatumChangeListener configChangeListener = spy(new DatumChangeListener() {
      @Override
  ...
  public void testFireConfigChange_event_notify_once()
    ...
    AbstractDatum abstractConfig = new ErrorConfig();
    ...
    final DatumChangeListener configChangeListener1 = spy(new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
    ...
    final DatumChangeListener configChangeListener2 = spy(new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
        invokeCount.incrementAndGet();
   ...
   * @author wxq
   */
  private static class ErrorConfig extends AbstractDatum {

...
public class BootstrapConfigTest {
  ...
  private static final String TEST_BEAN_CONDITIONAL_ON_KEY = "zoo.test.testBean";
  ...
  public static class TestWithBootstrapEnabledAndDefaultNamespacesAndConditionalOn extends
    ...
    private static Datum mockedConfig;
    ...
    public static void beforeClass() throws Exception {
      ...
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED, "true");

      mockedConfig = mock(Datum.class);
    ...
    public static void afterClass() throws Exception {
      System.clearProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED);
  ...
  public static class TestWithBootstrapEnabledAndNamespacesAndConditionalOn extends
    ...
    public static void beforeClass() throws Exception {
      ...
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED, "true");
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_NAMESPACES,
          String.format("%s, %s", ConfigConsts.NAMESPACE_APPLICATION, FX_ZOO_NAMESPACE));
      ...
      mockConfig(FX_ZOO_NAMESPACE, config);
    }

    @AfterClass
    public static void afterClass() throws Exception {
      System.clearProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED);
      System.clearProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_NAMESPACES);
  ...
  public static class TestWithBootstrapEnabledAndNamespacesAndConditionalOnWithYamlFile extends
    ...
    public static void beforeClass() throws Exception {
      ...
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED, "true");
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_NAMESPACES,
          String.format("%s, %s", "application.yml", FX_ZOO_NAMESPACE));

//      prepareYamlConfigFile("application.yml", readYamlContentAsConfigFileProperties("case6.yml"));
      Datum anotherConfig = mock(Datum.class);

      mockConfig(ConfigConsts.NAMESPACE_APPLICATION, anotherConfig);
      mockConfig(FX_ZOO_NAMESPACE, anotherConfig);
    }
  ...
  public static class TestWithBootstrapEnabledAndDefaultNamespacesAndConditionalOnFailedWithYamlFile extends
    ...
    public static void beforeClass() throws Exception {
      ...
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED, "true");
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_NAMESPACES, "application.yml");
...
//      prepareYamlConfigFile("application.yml", readYamlContentAsConfigFileProperties("case8.yml"));
  ...
  public static class TestWithBootstrapEnabledAndEagerLoadEnabled extends
    ...
    public static void beforeClass() {
      ...
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED, "true");
      System.setProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_EAGER_LOAD_ENABLED, "true");
    ...
    public static void afterClass() {
      System.clearProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_ENABLED);
      System.clearProperty(PropertySourcesConstants.ZOO_BOOTSTRAP_EAGER_LOAD_ENABLED);
    ...
    public void test() {
      ...
      boolean containsZoo = false;
      for (String name : names) {
        if (name.equals("com.wxius.framework.zoo.spring.boot.ZooApplicationContextInitializer")) {
          containsZoo = true;
          break;
        }
      }
      Assert.assertTrue(containsZoo);
    }
  }

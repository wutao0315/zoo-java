...
public class DefaultConfigFactoryTest {
  private DefaultDatumFactory defaultConfigFactory;
  ...
  public void setUp() throws Exception {
    ...
    defaultConfigFactory = spy(new DefaultDatumFactory());
  }
  ...
  public void testCreate() throws Exception {
    ...
    LocalRepository someLocalConfigRepo = mock(LocalRepository.class);
    when(someLocalConfigRepo.getDatum()).thenReturn(someProperties);

//    doReturn(someLocalConfigRepo).when(defaultConfigFactory).createConfigRepository(someNamespace);

    Datum result = defaultConfigFactory.create(someNamespace);

    assertThat("DefaultConfigFactory should create DefaultConfig", result,
        is(instanceOf(DefaultDatum.class)));
...
//    when(someRepository.getDatum()).thenReturn(someProperties);
//

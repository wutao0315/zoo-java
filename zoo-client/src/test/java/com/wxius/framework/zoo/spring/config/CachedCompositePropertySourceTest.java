...
public class CachedCompositePropertySourceTest {
  ...
  private List<DatumChangeListener> listeners;
  ...
  public void setUp() throws Exception {
    ...
    Mockito.doAnswer(new Answer() {
      ...
      public Object answer(InvocationOnMock invocation) throws Throwable {
        DatumChangeListener listener = invocation.getArgument(0, DatumChangeListener.class);
        listeners.add(listener);
        return Void.class;
      }
    }).when(configPropertySource).addChangeListener(any(DatumChangeListener.class));
  ...
  public void testAddFirstPropertySource() {
    ...
    final List<DatumChangeListener> anotherListenerList = new LinkedList<>();
    Mockito.doAnswer(new Answer() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
        DatumChangeListener listener = invocation.getArgument(0, DatumChangeListener.class);
    ...
    }).when(anotherSource).addChangeListener(any(DatumChangeListener.class));

 ...
 */
public class DefaultDatumTest {
  private File someResourceDir;
  private String someNamespace;
  private LocalRepository configRepository;
...
//  private ConfigSourceType someSourceType;
  ...
  public void setUp() throws Exception {
    ...
    configRepository = mock(LocalRepository.class);
  }
  ...
  public void testGetPropertyWithAllPropertyHierarchy() throws Exception {
    ...
    DefaultDatum defaultConfig =
        new DefaultDatum(someNamespace, configRepository);
  ...
  public void testGetIntPropertyMultipleTimesWithShortExpireTime() throws Exception {
    ...
    final DefaultDatum defaultConfig =
        new DefaultDatum(someNamespace, configRepository);
  ...
  public void testOnRepositoryChange() throws Exception {
    ...
    DatumChangeListener someListener = new DatumChangeListener() {
      @Override
  ...
  public void testFireConfigChangeWithInterestedKeys() throws Exception {
    ...
    DatumChangeListener interestedInAllKeys = new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
    ...
    DatumChangeListener interestedInSomeKey = new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
    ...
    DatumChangeListener interestedInSomeKeyNotChanged = new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
    ...
    DefaultDatum config = new DefaultDatum(someNamespace, mock(LocalRepository.class));
  ...
  public void testRemoveChangeListener() throws Exception {
    ...
    DatumChangeListener anotherListener = new DatumChangeListener() {
      @Override
      public void onChange(ConfigChangeEvent changeEvent) {
        if (someConfigChangeEvent == changeEvent) {
    ...
    DatumChangeListener yetAnotherListener = mock(DatumChangeListener.class);
  ...
  public void testGetPropertyNames() {
    ...
    DefaultDatum defaultConfig = new DefaultDatum(someNamespace, configRepository);
...
//    ConfigSourceType someSourceType = ConfigSourceType.REMOTE;
    ...
    when(configRepository.getDatum()).thenThrow(mock(RuntimeException.class));
  ...
  private void checkDatePropertyWithFormat(Datum config, Date expected, String propertyName, String format, Date
      defaultValue) {
    assertEquals(expected, config.getDateProperty(propertyName, format, defaultValue));
  }

  private void checkDatePropertyWithoutFormat(Datum config, Date expected, String propertyName, Date defaultValue) {

...
public class ZooClientEnvironmentVariablesCompatibleTest {
  ...
  public void testEnvironmentVariablesCompatible() throws Exception {
    SystemLambda.withEnvironmentVariable(
        ZooClientSystemConsts.DEPRECATED_ZOO_CACHE_DIR_ENVIRONMENT_VARIABLES,
        "test-2/cacheDir")
        .and(ZooClientSystemConsts.DEPRECATED_ZOO_ACCESS_KEY_SECRET_ENVIRONMENT_VARIABLES,
            "test-2-secret")
        .and(ZooClientSystemConsts.DEPRECATED_ZOO_CONFIG_SERVICE_ENVIRONMENT_VARIABLES,

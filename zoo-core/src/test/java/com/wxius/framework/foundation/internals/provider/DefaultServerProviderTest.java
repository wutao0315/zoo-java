...
import static com.wxius.framework.foundation.internals.provider.DefaultServerProvider.DEFAULT_SERVER_PROPERTIES_PATH_ON_LINUX;
import static com.wxius.framework.foundation.internals.provider.DefaultServerProvider.DEFAULT_SERVER_PROPERTIES_PATH_ON_WINDOWS;
...
import com.wxius.framework.foundation.internals.provider.DefaultServerProvider;
...
public class DefaultServerProviderTest {
  ...
  private void cleanUp() {
    ...
    System.clearProperty("zoo.path.server.properties");
  }
  ...
  public void testGetServerPropertiesPathCustom() {
    ...
    System.setProperty("zoo.path.server.properties", customPath);

 ...
 *
 */
package com.wxius.framework.foundation.internals;

import java.util.LinkedHashMap;
import java.util.Map;

import com.wxius.framework.foundation.internals.provider.DefaultApplicationProvider;
import com.wxius.framework.foundation.internals.provider.DefaultNetworkProvider;
import com.wxius.framework.foundation.internals.provider.DefaultServerProvider;
import com.wxius.framework.foundation.spi.ProviderManager;

 ...
 *
 */
package com.wxius.framework.zoo.core.internals;
...
/**
 * For legacy meta server configuration use, i.e. zoo-env.properties
 */
public class LegacyMetaServerProvider implements MetaServerProvider {
  ...
  private void initialize() {
    ...
    prop = ResourceUtils.readConfigFile("zoo-env.properties", prop);
